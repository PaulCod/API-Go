...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é posssivel deletar um usuario que não seja o seu"))
		return
	}
...
// SeguirUsuario permite que um usuario sigua outro
...
// BuscarSeguindo tras todos os usuarios que um determinado usuario esta seguindo
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel atualizar a senha um usuario que não seja o seu"))
		return
	}
