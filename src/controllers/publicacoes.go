...
// BuscarPublicacao traz as publicações que apareceriam no feed do usuario
...
// BuscarPublicacao traz uma unica publicão
...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	respostas.Erro(w, http.StatusNoContent, nil)

}

// DeletarPublicacao exclui o dados de uma publicação
func DeletarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel deletar uma publicacao que não é sua"))
		return
	}
...
// BuscarPublicacoesPorUsuario trz todas as publicacoes de um usuario
...
// CurtirPublicacao adiciona uma curtida na publicaçao
